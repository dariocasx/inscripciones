        ...
        <div class="section-top-border">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <h3 class="mb-30">Presentar una solicitud de inscripción al curso</h3>
                    @guest
                        <p>Si tiene cuenta, inicie sesión con sus credenciales <a href="{{ route('enroll.handleLogin', $course->id) }}">here</a>.</p>
                    @endguest
